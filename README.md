...
- **Video Recording** - Support operation demo video recording and playback
- **Rate Limiting** - API endpoints with complete rate limiting and security protection
...
- **Demo Recording**: Record operation demo videos for documentation and training
...
- **API Security**: All API endpoints have rate limiting and security protection

## 📦 部署选项 (Deployment Options)

### 本地部署 (Local Deployment)
```bash
git clone https://github.com/huige-org/diffagent.git
cd diffagent
npm install
npm start
```
...
- Rate limiting and security protection for APIs
